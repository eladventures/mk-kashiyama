...
const _imports_0 = "" + __buildAssetsURL("mk-passenger-pad.DtDDXIVX.jpg");

const _imports_1 = "" + __buildAssetsURL("mk-passenger-shoe.CuK1se0E.jpg");

const _imports_2 = "" + __buildAssetsURL("mk-brake.r5RwE594.jpg");

const heroImg = "" + __buildAssetsURL("mk-logo-sm.CyxBMgWJ.jpg");
